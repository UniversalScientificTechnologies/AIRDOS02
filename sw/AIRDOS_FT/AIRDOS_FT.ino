...
String FWversion = "F4";
#define ZERO 254  // 5th channel is channel 1 (column 10 from 0, ussually DCoffset or DCoffset+1)

/*
  AIRDOS with RTC (AIRDOS-F) plus temperature and pressure sensor
